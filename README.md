...
- AWS SSOを使用してローカル環境からTerraformを実行する設定：[linked-aws-and-auth0-by-event-streamブランチ](https://github.com/maronnjapan/sample-id-app/tree/linked-aws-and-auth0-by-event-stream)
